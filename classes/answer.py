...
class Answer:
    ...
    def __init__(self, number_of_row=-1):
        self.ir_system = IRS(number_of_row)

    def q1(self):
        text_all_file = self.ir_system.read_all_row()
        list_token = self.ir_system.tokenizer(text_all_file)
        list_clean_token = self.ir_system.clean_word(list_token)
    ...
    def q2(self, out_of: int = -1):
        ...
        list_token = self.ir_system.tokenizer(text_all_file)
        list_clean_token = self.ir_system.clean_word(list_token)
        dict_token = self.ir_system.generate_stopwords(list_clean_token)
        list_rank = self.ir_system.add_value_to_list(dict_token)
        sorted_dict = self.ir_system.sort_dict(dict_token, list_rank, out_of)
    ...
    def q3(self):
        text_title_and_plot = self.ir_system.read_title_and_plot()
        list_tokenize_title_and_plot = self.ir_system.tokenize_title_and_plot(text_title_and_plot)
        posting_title_and_plot = self.ir_system.posting_title_and_plot(list_tokenize_title_and_plot)
    ...
    def q4(self):
        text_title_and_plot_with_change = self.ir_system.edit_read_title_and_plot()
        list_tokenize_title_and_plot_with_change = self.ir_system.tokenize_title_and_plot(text_title_and_plot_with_change)
        posting_title_and_plot_with_change = self.ir_system.posting_title_and_plot(list_tokenize_title_and_plot_with_change)
